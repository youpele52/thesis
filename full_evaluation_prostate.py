...
class FullEvaluation:
    ...
    def run_FullEvaluation_folder_based(pred_dir, gt_dir,pred_nametag, gt_nametag,volume_threshold, patientID_position = 1):
        ...
        '''
        Runs full evaluation for a training or test session.
        
        Parameters
        ----------
        pred_dir : str
            Path to predicted nifti files.
        gt_dir : str
            Path to the GT nifti files
        pred_nametag : str
            The predicted files name tag
        gt_nametag : str
            The GT files name tag
        volume_threshold: int
            Volume threshold.
        patientID_position: int, Default is 1
            Position in the str paths where the patient ID is, ie P001
    ...
    def run_FullEvaluation_DeepMedic_based(pred_dir, gt_dir,pred_nametag, gtLabels_ConfigFile,volume_threshold,
        ...
        gtLabels_ConfigFile : str
            Path to the GT label config that contains all the paths of the GT files.
        volume_threshold: int
            Volume threshold.
        patientID_position: int
            Position in the str paths where the patient ID is, ie P001
        path_delimiter : str, Default is "\\" for Windows PC.
