...
#  Resampling the dataset.. you have to change the main dir to test, validation and then to test

todays_date = datetime.now().strftime('%d%m20%y')
main_dir = '/home/lenzmi/deepmedic/prostate_risk/data/withoutPIRADS/res_to_T2/train'
