...
class pickT2TSEFile():
    ...
    def get_all(prostate_path):
        ...
        ADC_info = pickT2TSEFile.get_ADC_info(prostate_path)
        
        filename = "T2TSE_GraSe_ADC_" + date + ".xlsx"
            
        with pd.ExcelWriter( os.path.join(prostate_path,filename) ) as writer:
            T2TSE_info.to_excel(writer, sheet_name = "T2TSE_info")
            GraSe_info.to_excel(writer, sheet_name = "GraSe_info")
            ADC_info.to_excel(writer, sheet_name = "ADC_info")
...
# gg = pickT2TSEFile.get_T2LO_prefix(prostate_path= r"C:\Users\michaely\Documents\hiwi\Prostate")

# getsome = pickT2TSEFile.get_T2TSE_info(prostate_path= r"C:\Users\michaely\Documents\hiwi\Prostate")


# get_grase = pickT2TSEFile.get_GraSe_info(prostate_path= r"C:\Users\michaely\Documents\hiwi\Prostate")


getall = pickT2TSEFile.get_all(prostate_path= r"C:\Users\michaely\Documents\hiwi\Prostate")

# whynot = pickT2TSEFile.get_ADC_info(prostate_path= r"C:\Users\michaely\Documents\hiwi\Prostate")
