...
def after_full_evaluation(predict_test_result, test_cases, export_dir, test_session_name, 
                          delimeter = "/", delimeter2 = "/", case_ID1_position = -2, case_ID2_position = 1 ):
    ...
    for a in range(0,10,1):
        case_ID1 = test_result.iloc[a:a+1,2:3].to_numpy()[0][0].split(delimeter)[case_ID1_position] #.split("_")[1])
        ...
        for content in os.listdir(test_cases):
            if 'label_1' in content:
                ...
                # Case ID
                case_ID2 =  (file_path.split(delimeter2)[-1].split("_")[case_ID2_position])
